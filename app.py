...
#app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:root@localhost/proyecto?useSSL=false&serverTimezone=UTC'
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:wcbnjd9ycbpjukmvx2wwofh5vhfdgb36@monorail.proxy.rlwy.net:25231/railway?useSSL=false&serverTimezone=UTC'
# Configura la base de datos utilizando las variables de entorno
app.config['SQLALCHEMY_DATABASE_URI'] = f"mysql+pymysql://{os.environ['MYSQLUSER']}:{os.environ['MYSQLPASSWORD']}@{os.environ['MYSQLHOST']}/{os.environ['MYSQLDATABASE']}"
